...
const phases = {
  ...
  test: {namespace:'adccd1-test'    , name: `${name}`, phase: 'test'  , changeId:changeId, suffix: `-test-${changeId}`  , instance: `${name}-test-${changeId}`  , version:`${version}-${changeId}`, tag:`test-${version}-${changeId}`},
